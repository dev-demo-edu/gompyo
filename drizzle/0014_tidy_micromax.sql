ALTER TABLE `partners` RENAME TO `quotation_companies`;--> statement-breakpoint
...
INSERT INTO `__new_quotation_companies`("id", "company_name", "company_type", "created_at", "updated_at") SELECT "id", "company_name", "company_type", "created_at", "updated_at" FROM `quotation_companies`;--> statement-breakpoint
DROP TABLE `quotation_companies`;--> statement-breakpoint
ALTER TABLE `__new_quotation_companies` RENAME TO `quotation_companies`;--> statement-breakpoint
...
ALTER TABLE `__new_quotation_companies_items` RENAME TO `quotation_companies_items`;
