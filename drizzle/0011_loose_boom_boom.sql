...
ALTER TABLE `costs` ADD `gompyo_labor_cost` real;--> statement-breakpoint
ALTER TABLE `costs` ADD `gompyo_transport_storage_fee` real;--> statement-breakpoint
ALTER TABLE `costs` ADD `gompyo_loading_unloading_fee` real;
